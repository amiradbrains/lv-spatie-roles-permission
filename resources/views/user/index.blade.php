                    ...
                    <table class="min-w-full bg-white dark:bg-gray-800 border-collapse">
                        <thead class="bg-gray-100 dark:bg-gray-700 border-b">
                            <tr>
                                ...
                                <th class="py-2 px-4 text-left dark:text-gray-300">Email</th>
                                <th class="py-2 px-4 text-left dark:text-gray-300">Assigned Roles</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            @if ($loggedInUserRoles->contains('Super-Admin') || !$roleNames->contains('Super-Admin'))
                                <tr>
                                    <td class="py-2 px-4 border dark:border-gray-700">{{ $user->name }}</td>
                                    <td class="py-2 px-4 border dark:border-gray-700">{{ $user->email }}</td>
                                    <td class="py-2 px-4 border dark:border-gray-700">
                                        @if ($roleNames->isNotEmpty())
                                            @foreach ($roleNames as $roleName)
                                                <span class="bg-blue-500 rounded text-white text-sm p-1">{{ $roleName }}</span>
                                            @endforeach
                                        @endif
                                    </td>
                                    <td class="py-2 px-4 border dark:border-gray-700">
